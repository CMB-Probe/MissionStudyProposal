...
complexities. The models will be informed by physical inputs~\cite{draine_fraisse_2009,Hensley_etal} 
and measurements, for example the spatial variations of the spectral dependence, decorrelation between frequencies, and departures from a simple modified black body law for Galactic dust~\cite{planck2015_x,planck2016_l,planck2016_xxix,Boulanger2016}. 
...
used with the \planck\ data~\cite{planck2015_ix}. The WG will extract cosmological and astrophysical information from the component maps and their power spectra, and compare to the input values to assess the residual 
