...
contribute a change to $\Neff$ of at least $\Delta \Neff \geq g \, 0.027$ where $g \geq 1$ is the number of degrees of freedom of the new particle.  
...
In particular, it changes the locations of the acoustic peaks and alters the damping tail at high-$\ell$.  Similar changes to the spectra 
...
spectrum to that of the other CMB spectra. But the sensitivity to $\sum m_\nu$ is limited by our knowledge of 
...
The blue dashed line is the current \planck limit; the white dashed line is the limit from cosmic variance 
measurement of $\tau$. 
