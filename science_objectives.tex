...
The sensitivity of the Cosmic Microwave Background to the primordial inhomogeneities in the gravitational potential provides a remarkable observational link to the dynamics of the universe before the present hot big bang era. There are additional degrees of freedom in the primordial metric, the tensor (and vector) modes, that were certainly present in the early universe and whose possible statistics are currently more restricted by observation than by theory. The B-mode polarization of the CMB is sensitive to those modes. A detection would also reveal completely new information about the primordial era, providing significant constraints and consistency checks for current models or perhaps even overturning them. A significantly improved upper limit would rule out wide classes of currently consistent models. Any detection would have consequences far beyond the difficult question of cosmological dynamics by providing evidence for a new scale of particle physics near the GUT scale. In the context of an inflation, the relationship is particularly clear: potential energy $V$ of the inflaton to is related to the tensor-to-scalar ratio $r$ at the peak of the spectrum by $V^{1/4} = 3.7 \times 10^{16} \ r^{1/4}\,\, {\rm GeV}$. 
...
B-mode spectra are shown for vacuum fluctuations from inflation for two representative values of the tensor-to-scalar
