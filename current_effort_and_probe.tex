...
%which are designed to realize the full potential of this
%unique probe of fundamental physics and astrophysics.    
...
%are reachable only through mapping of the largest angular scales. 
No sub-orbital experiment 
has yet produced any polarization results on more than 2\% of the sky, let alone 
on scales requiring $>70\%$, which are crucial for achieving some
...
scales.
%, including those important for removing the effects of $B$ modes due to lensing. 
...
study, these past exercises suggest that a polarization imager fits within the \$400M - \$1000M class.
...
The US LiteBIRD team has proposed participation in LiteBIRD and recently submitted its Phase A 
