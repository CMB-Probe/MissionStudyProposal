...
\setlength{\baselineskip}{1.0\baselineskip} %% measured, 5.0 lines/inch.  Can go to 0.96\baselineskip
...
\input{science_objectives.tex}

%\newpage

\vspace{-0.22in}

\input{foregrounds.tex}
...
\input{current_effort_and_probe.tex}
