...
The most significant advances since then have been made in developing detector and readout technologies, and in optical components.
The baseline imager, enjoying technologies of a decade ago
%Sub-orbital experiments now routinely implement thousands. 
As the paragraphs below describe, a future CMB probe with the technologies would be 
more powerful than that envisioned with the baseline mission, and orders of magnitude more sensitive than \planck.  \\
